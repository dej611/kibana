...
const createStartContract = (): jest.Mocked<Start> => {
  const startContract = {
    ui: {
      TopNavMenu: jest.fn(createTopNav(unifiedSearchMock, [])),
      AggregateQueryTopNavMenu: jest.fn(createTopNav(unifiedSearchMock, [])),
      createTopNavWithCustomContext: jest.fn(createTopNav(unifiedSearchMock, [])),
    },
