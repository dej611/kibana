...
export const aggTSDBRateName = 'aggTSDBRate';

type Input = any;
type AggArgs = AggExpressionFunctionArgs<typeof METRIC_TYPES.TSDB_RATE>;
type Output = AggExpressionType;
type FunctionDefinition = ExpressionFunctionDefinition<
  typeof aggTSDBRateName,
  Input,
  AggArgs,
  Output
>;

export const aggTSDBRate = (): FunctionDefinition => ({
  name: aggTSDBRateName,
