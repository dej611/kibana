...
export const rateOperation: OperationDefinition<RateIndexPatternColumn, 'field', {}, true> = {
  ...
  getPossibleOperationForField: ({
    ...
    if (supportedTypes.has(type) && aggregatable && timeSeriesMetricType === 'counter') {
  ...
  isTransferable: (column, newIndexPattern) => {
    ...
    return Boolean(
      newField &&
        ...
        newField.timeSeriesMetricType === 'counter' &&
  ...
  toEsAggsFn: (column, columnId) => {
    return buildExpressionFunction<AggFunctionsMapping['aggTSDBRate']>('aggTSDBRate', {
      id: columnId,
      enabled: true,
      schema: 'metric',
      ...
      aggregateFn: column.params?.aggregateFn ?? 'sum',
    }).toAst();
  },
