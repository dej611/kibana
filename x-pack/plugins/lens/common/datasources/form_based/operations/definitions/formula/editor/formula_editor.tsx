...
export function WrappedFormulaEditor() {
  return <div>FormulaEditor</div>;
}
...
// import { nonNullable, useDebounceWithOptions } from '../../../../../../utils';
...
//   // on first render
//   if (!overflowDiv1?.current && typeof document !== undefined) {
